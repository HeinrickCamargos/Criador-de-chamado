...
class chamado
{
    ...
    public function adicionar(string $nome, string $email, string $cpf, string $servico, string $nome_demanda, string $operadora, string $problematica) : void{
        ...
        $inserecliente = $this->mysql->prepare('INSERT INTO cliente, demanda ( nome, email, cpf, servico) VALUES(?,?,?,?);');
    ...
    public function remover (string $id) : void{
        ...
        $removerchamado = $this->mysql->prepare('DELETE FROM `demanda`, `cliente WHERE id = ?');
